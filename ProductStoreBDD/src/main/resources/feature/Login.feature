...
When I enter my name as 'kavya' and country as 'India' and city as 'Nellore' and credit card as '605385697632' and month as 'nov' and year as '2022' and click on purchase order
